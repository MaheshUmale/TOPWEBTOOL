# DOX Framework - ROI CALCULATOR

## Purpose
This directory contains the ROI CALCULATOR web tool and its supporting documentation pages for TopWebTool.com.
...
- `roi-calculator-best-practices.html` - Supporting article
- `roi-calculator-common-errors.html` - Supporting article
- `roi-calculator-future-trends.html` - Supporting article
- `roi-calculator-guide.html` - Supporting article
- `roi-calculator-optimization-tips.html` - Supporting article
