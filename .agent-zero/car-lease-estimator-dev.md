# DOX Framework - CAR LEASE ESTIMATOR

## Purpose
This directory contains the CAR LEASE ESTIMATOR web tool and its supporting documentation pages for TopWebTool.com.
...
- `how-to-calculate-car-lease.html` - Supporting article
- `how-to-negotiate-car-lease.html` - Supporting article
- `lease-vs-buy-car.html` - Supporting article
- `residual-value-explained.html` - Supporting article
- `understanding-money-factor.html` - Supporting article
