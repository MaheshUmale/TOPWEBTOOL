# DOX Framework - MORTGAGE CALCULATOR

## Purpose
This directory contains the MORTGAGE CALCULATOR web tool and its supporting documentation pages for TopWebTool.com.
...
- `amortization-schedule-explained.html` - Supporting article
- `extra-payments-savings.html` - Supporting article
- `how-to-calculate-mortgage.html` - Supporting article
- `property-tax-insurance-guide.html` - Supporting article
- `understanding-pmi.html` - Supporting article
