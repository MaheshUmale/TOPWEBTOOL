...
### Child Tool Directories (each with own AGENTS.md)
- `ai-text-humanizer-helper/` - AI text humanization tool
- `base64-encoder-decoder/` - Base64 encoding/decoding utility
- `car-lease-estimator/` - Car lease estimation tool
- `chatgpt-prompt-optimizer/` - ChatGPT prompt optimization tool
...
- `json-formatter-validator/` - JSON formatter and validator
...
- `AGENTS.md` - Root DOX rail (this file)
- `FINDINGS.txt` - Third-party audit findings
- `GUIDE.txt` - SEO and AdSense optimization guide
