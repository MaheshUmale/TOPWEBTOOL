# DOX Framework - INFLATION CALCULATOR

## Purpose
This directory contains the INFLATION CALCULATOR web tool and its supporting documentation pages for TopWebTool.com.
...
- `eurostat-inflation-explained.html` - Supporting article
- `historical-us-inflation-trends.html` - Supporting article
- `how-inflation-affects-buying-power.html` - Supporting article
- `how-to-protect-savings-from-inflation.html` - Supporting article
- `what-is-cpi-index.html` - Supporting article
